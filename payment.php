...
<div class="container">
        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-5 mb-lg-0 mb-3">
                                    <?php
                                        ...
                                        $amnt = $_REQUEST['amnt']-250;
                                         
                                        }
                                         if($_REQUEST['user_type']==4)
                                        {
                                                      
                                        $amnt = $_REQUEST['amnt']-750;
                                         
                                        } if($_REQUEST['user_type']==5)
                                        {
                                        ...
                                        $amnt = $_REQUEST['amnt']-250;
                                                                                 ...
                                                                                 ?>
                                    <p class="mb-0">
                                        <span class="fw-bold">Price1:</span>
                                        <span class="c-green">:₹<?php echo $amnt;?></span>
                                ...
                                <div class="col-lg-7">
                                    <form action="save_payment.php" class="form" method="POST">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form__div">
                                            ...
                                            <div class="col-6">
                                                <div class="form__div">
                                                    <input type="text" class="form-control" placeholder=" " name="exp_date">
                                            ...
                                            <div class="col-6">
                                                <div class="form__div">
                                                    <input type="password" class="form-control" placeholder=" " name="cvv_number">
                                                    <label for="" class="form__label">cvv code</label>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form__div">
                                                    <input type="text" class="form-control" placeholder=" " name="card_holder">
                                                    <label for="" class="form__label">name on the card</label>
                                                </div>
                                            </div>
                                        <div class="col-12">
                                                <input type="submit" class="submit" onclick="click1()">
                                            </div> 
                                        </div>
                                    </form>
                                </div>
            ...
            <div class="col-12">
                <div type="submit" class="btn btn-primary payment"  type="submit"  onclick="click1()">
                    Make Payment
                </div>
